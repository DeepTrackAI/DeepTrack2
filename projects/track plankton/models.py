...
def generate_unet(
    im_size_height=None, im_size_width=None, no_of_inputs=1, no_of_outputs=2
):
    #     image_size
    model = unet(
...
def train_model_early_stopping(
    model, generator, patience=15, epochs=500, steps_per_epoch=10
):
    callback = C.EarlyStopping(
